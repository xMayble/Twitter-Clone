...
class TweetCellTableViewCell: UITableViewCell {
    ...
    func setRetweeted(_ isRetweeted:Bool) {
        if (isRetweeted) {
            ...
            retweetButton.setImage(UIImage(named: "default_retweet"), for: UIControl.State.normal)
    ...
    func setFavorite(_ isFavorited:Bool){
        ...
        if (favorited) {
            ...
            favButton.setImage(UIImage(named:"favor_icon (1)"), for: UIControl.State.normal)
        }
    }
